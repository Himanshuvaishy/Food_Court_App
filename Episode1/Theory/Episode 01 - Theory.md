...
// firstparse html----> if encounter ---->script it download parallel  and when it avilable it start execute  and pause the html parsing after the script tag execute it will start again html parsing
### _Syntax_
...
// firstparse html----> if encounter ---->script it download parallel but execute after the Dom construction
